    ...
    try {
      if (isLogin) {
        ...
        if (error) {
          ...
          console.log("[Auth] Login success with email:", email);
          console.log("[Auth] Admin email check:", { email, ADMIN_EMAIL, isAdminLogin });
          
          toast({
            title: "Chào mừng trở lại! 🐝",
            description: isAdminLogin ? "Đăng nhập Admin thành công" : "Đăng nhập thành công",
          });
